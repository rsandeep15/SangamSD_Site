  ...
  $.backgroundVideo = function(el, options) {
    ...
    var buildVideo = function () {
      ...
      html += 'style="display:none;position:fixed;top:0;left:0;bottom:0;right:0;z-index:0;width:100%;height:100%;filter:blur(5px) saturate(140%);">';
        ...
        html += '<source src="http://sangamsd.ucsd.edu/wp-content/uploads/2016/07/front.mp4" type="video/mp4" />';
        html += '<source src="http://sangamsd.ucsd.edu/wp-content/uploads/2016/07/front.ogv" type="video/ogg" />';
        html += '<source src="http://sangamsd.ucsd.edu/wp-content/uploads/2016/07/front.webm" type="video/webm" />';
